...
with DAG(
    ...
    get_wksp_contents_task = PythonOperator(
            task_id = 'get_wksp_contents',
            python_callable= get_workspace_contents,
            op_kwargs= {"ngc_api_key": key_, "org":org_, "workspace_id": "Wm4074mZQ46Mr3u-NaLkXw"},
            dag = dag)



create_gpt_workspace_task >> get_wksp_contents_task
